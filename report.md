...
PIE CHART:
The first thing you notice looking at this chart is just how much space the blue Rock slice takes up it dominates the entire chart. Every other genre like Funk, Jazz, Blues, Pop and Hip Hop are squeezed into tiny slivers around the edge that are barely visible. Funk is the only one that stands out slightly in orange, but even that is nowhere near Rock's size. The chart alone makes the imbalance obvious without needing any numbers to back it up.  

BAR CHART:
The Beatles and Bruce Springsteen sit at the top with around 7 entries each, followed by The Rolling Stones at roughly 6. After that there is a noticeable drop — David Bowie comes in around 4 or 5 and Prince along with the remaining artists all sit at around 2. The gap between the top three and everyone else is what really stands out, showing that a very small group of artists hold most of the representation.

LINE CHART:
The chart starts almost flat in the 1950s, rises steeply through the 1960s, and peaks in the 1970s at around 84 albums. From there it drops sharply through the 1980s and keeps falling until it nearly flattens out by the 2000s. The shape is almost like a mountain with the 1970s sitting right at the top, making it very clear which decade this ranking is built around.
